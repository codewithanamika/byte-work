    ...
    <footer className="bg-blue-950 text-white py-8 sm:py-10 mt-8 sm:mt-12 relative">
      <div className="container mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between gap-6 sm:gap-8">
        <div>
          ...
          <h4 className="text-xs sm:text-sm uppercase mb-3 sm:mb-4 px-3 sm:px-4">
            Hotels
          </h4>
        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-0">
            <input
              ...
              className="p-2 sm:p-3 rounded-tl rounded-bl text-amber-50 focus:outline-none border-yellow-500 border-2 w-full sm:w-auto text-xs sm:text-sm"
            />
